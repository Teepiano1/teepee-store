...
return (
  <div className="h-[100svh] grid grid-rows-[4rem_1fr] overflow-hidden">
    <header className="shadow-md flex items-center justify-between px-[2rem]">
      <h1 className="font-bold text-xl text-[#380C65]">TEEPEE STORE</h1>
    ...
    <main className=" grid grid-cols-[13rem_1fr] sm:grid-cols-[1fr_0rem] sm:max-h-[100vh]   overflow-hidden">
